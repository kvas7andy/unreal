...
def get_options(option_type):
  ...
  tf.app.flags.DEFINE_float("dropout", 0.0, "dropout for encoder")
  ...
  tf.app.flags.DEFINE_integer("n_step_TD", 50, "size n for n-step TD")
  tf.app.flags.DEFINE_float("entropy_beta", 0.0001, "entropy regularization constant")

  # For training
  if option_type == 'training':
    tf.app.flags.DEFINE_float("greedy_epsilon", 0.99, "gready action choice")
