...
def get_options(option_type):
  ...
  tf.app.flags.DEFINE_integer("segnet", 0, "use segmentation mode: 0 - no, 1 - encoder only, 2 - decoder on encoder, 3 - decoder on lstm output")
  ...
  if option_type == 'training':
    ...
    tf.app.flags.DEFINE_integer("save_interval_step", 50 * 1000, "saving interval steps") # 100*1000
